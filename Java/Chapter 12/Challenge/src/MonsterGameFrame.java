...
public class MonsterGameFrame extends JFrame {	
	...
	public MonsterGameFrame() {
		...
		gamePanel.setFocusable(true); // GamePanel이 포커스를 받을 수 있도록 설정한다.
	...
	class GamePanel extends JPanel {
		...
		private static final int AVATAR_MOVE = 10; // 아바타가 한번에 움직이는 픽셀 수
	...
	class MonsterThread extends Thread {
		...
		private long monsterDelay;
		private static final int MONSTER_MOVE = 5; // from 레이블이 한번에 이동하는 거리
